...
# 목적: Qwen3-TTS 서버를 VoiceDesign 모델 + Flash-Attention 최적화 모드로 실행합니다.
...
# 3. VoiceDesign 1.7B 모델 사용 (instruct 기반 목소리 창조)
#    CustomVoice로 전환하려면 아래 줄의 주석을 해제하세요:
#    export QWEN_TTS_MODEL="Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice"
export QWEN_TTS_MODEL="Qwen/Qwen3-TTS-12Hz-1.7B-VoiceDesign"

echo "=================================================="
echo "🚀 Qwen3-TTS VoiceDesign API 서버 구동을 시작합니다..."
echo "   모델: $QWEN_TTS_MODEL"
echo "=================================================="

# 4. 실제 파이썬 API 서버를 Uvicorn 다중 워커(4개)로 실행하여 동시 접속을 완벽히 분리합니다.
